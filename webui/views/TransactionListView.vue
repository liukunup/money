...
import TransactionFormModal from './transaction/TransactionFormModal.vue';
...
<template>
  <div class="transactions-view">
    ...
    <div class="transactions-list">
      <div v-for="(date, transactions) in groupedTransactions" :key="date" class="date-group">
    ...
    <TransactionFormModal
      v-if="showFormModal"
      :transaction="editingTransaction ? transactionsStore.transactions.find(transaction => transaction.id === editingTransaction.value) || null) : undefined"
